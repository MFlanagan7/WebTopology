export const changes = [
    'Built out basic UI layout',
    'Added placeholder logo and navigation',
    'Added placeholder search bar',
    'Implemented authentication with GCP',
    'Created data object model classes to handle various objects (racks, devices, etc.)',
